...
export const resetPassword = ({
  ...
  axios.put(`/api/v1/profiles/resetPassword`, {
    email
  })
  .then(res => {
...
export const submitNewPassword = ({
  ...
  axios.put(`/api/v1/profiles/newPassword`, {
    resetToken,
    password
  })
  .then(res => {
  ...
  .catch(err => {
    ...
    setTimeout(() => {
      that.passwordFail = false
    }, 3000)
    console.error(err)
  })

// Get Waiver Page Resources
export const getWaiverResources = ({
  commit
}, {
  resource
}) => {
...
export const campSessionCreate = ({
  commit
}, {
  newCamp,
  router
...
export const campSessionUpdate = ({
  commit
}, {
  updated_camp,
  camp_id,
...
export const campSessionDelete = ({
  commit
}, {
  campId,
  router
...
export const campSessionGetApplicants = ({
  commit
}, {
  camp_id
}) => {
...
export const campSessionsGetAll = ({
  commit
}, {
  field_name,
  order
...
export const getCountryNameFromKey = ({
  commit
}, key) => {
  return new Promise((resolve, reject) => {
